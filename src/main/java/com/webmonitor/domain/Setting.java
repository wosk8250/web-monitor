 ...
 * XSS 방어: discordWebhookUrl 필드는 setter에서 자동으로 HTML 이스케이프 처리
 */
...
public class Setting {
    ...
    @Size(max = 500, message = ValidationMessages.SETTING_WEBHOOK_URL_LENGTH)
    ...
    /**
     * XSS 방어: discordWebhookUrl setter 오버라이드
     * HTML 태그를 이스케이프 처리하여 XSS 공격 방지
     */
    public void setDiscordWebhookUrl(String discordWebhookUrl) {
        this.discordWebhookUrl = XssSanitizer.sanitize(discordWebhookUrl);
    }
}
