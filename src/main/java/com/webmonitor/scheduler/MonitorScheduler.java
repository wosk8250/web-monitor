...
public class MonitorScheduler {
    ...
    public void monitorSitesEveryMinute() {
        String currentTime = LocalDateTime.now().format(DiscordConstants.DISPLAY_FORMATTER);
        log.info("========================================");
        ...
        try {
            ...
            log.info("스케줄러 실행 완료: {}", LocalDateTime.now().format(DiscordConstants.DISPLAY_FORMATTER));
    ...
    //     log.info("5분 주기 모니터링 시작: {}", LocalDateTime.now().format(DiscordConstants.DISPLAY_FORMATTER));
    //     monitorService.monitorAllActiveSites();
    // }
    ...
    //     log.info("일일 모니터링 시작: {}", LocalDateTime.now().format(DiscordConstants.DISPLAY_FORMATTER));
    //     monitorService.monitorAllActiveSites();
    // }
    ...
    //     log.info("평일 오전 모니터링 시작: {}", LocalDateTime.now().format(DiscordConstants.DISPLAY_FORMATTER));
    //     monitorService.monitorAllActiveSites();
    // }
    ...
    //     log.info("초기 딜레이 후 모니터링: {}", LocalDateTime.now().format(DiscordConstants.DISPLAY_FORMATTER));
    //     monitorService.monitorAllActiveSites();
    // }
}
